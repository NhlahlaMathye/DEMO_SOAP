 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static CurrencyName parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CurrencyName object =
                new CurrencyName();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CurrencyName".equals(type)){
                                ...
                                return (CurrencyName)org.oorsprong.www.websamples_countryinfo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
