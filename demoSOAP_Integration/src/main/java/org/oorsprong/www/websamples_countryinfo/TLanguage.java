 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static TLanguage parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            TLanguage object =
                new TLanguage();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"tLanguage".equals(type)){
                                ...
                                return (TLanguage)org.oorsprong.www.websamples_countryinfo.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
